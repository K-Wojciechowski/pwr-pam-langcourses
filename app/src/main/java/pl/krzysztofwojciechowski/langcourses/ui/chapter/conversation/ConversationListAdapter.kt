...
class ConversationListAdapter(
    private val playPhrase: (ConversationItem) -> Unit,
    private val items: List<ConversationItem> = mutableListOf()
) :
    RecyclerView.Adapter<ConversationListAdapter.ConversationViewHolder>() {

    constructor(playPhrase: (ConversationItem) -> Unit, chapter: Chapter) : this(
        playPhrase,
